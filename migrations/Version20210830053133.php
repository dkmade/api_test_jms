 ...
 */
final class Version20210830053133 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE book_name (id INT NOT NULL, book_id INT NOT NULL, name TEXT NOT NULL, locale VARCHAR(2) NOT NULL, PRIMARY KEY(id))');
